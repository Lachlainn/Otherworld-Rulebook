...
Unfortunately, most of you are already dead. Sorry about that. You are now in the Otherworld. It's not a quite christian heaven or whatever, it's celtic. Go read about it if you want.

First off, learn how to play #link("https://cdn.1j1ju.com/medias/f4/4f/09-perudo-rulebook.pdf")[Perudo] (including the Calza rule) and then we can talk.

All done?

Great.

Otherworld is a crowd-decision improv dungeon crawler where you never have to go into a dungeon, and never have to make a decision. But you should get over that and make some decisions, I think.
...
= Order of Play
+ Players roll 2 dice. The highest rolling becomes the storyteller.
+ Supply the storyteller with the prompt cards and let them have a think!
+ The storyteller guides the players towards an conflict encounter, using their imagination. Though if this fails you, you can skip as much of this as you like. This is what the prompt cards are for. The storyteller is able to hand out free dice and discards, and allow the players to make rolls for engagement. Have fun with it!
+ Have a conflict! The storyteller shouldn't feel limited to just fighting things. #footnote[In the world, your conflict session could be racing, arguing with someone, or fighting the very earth below you to dig a hole. Go wild!]
+ If you haven't met your last stand condition, return to step 1.
+ If you have met your last stand condition #footnote[Or you just want to get the game over with!], do a last stand!

= Storyteller, Improv Phase
Honestly I need to beta test this before I give advice on this.

= Conflict Phase
#figure(
  image("media/playerOrder.svg", width: 80%),
  caption: [
...
During a conflict, storytellers almost like normal players, except can't draw ability cards, only play them! They should just do more evil laughing.

After their possession the storyteller can choose to EITHER: 
- Match dice with the player with the most dice
- Match number of ability cards with the player with the most ability cards
- Gain a dice
- Gain an ability card associated with the character they just played as (though players get first dibs if offered as loot)

= Tips and Notes on Conflict
== Secrecy
